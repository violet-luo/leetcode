...
Explanation: 
To solve the question without extra space, we cannot create a new list to store values.
1. since all numbers are positive, if a number exists, mark the index by flipping the number to negative
2. if a number repeats, no change
3. return the index of positive numbers we have not visited
